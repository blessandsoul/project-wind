...
import { generationRoutes } from '@modules/generations/generations.routes.js';
import { creditRoutes } from '@modules/credits/credits.routes.js';
import { aiModelRoutes } from '@modules/ai-models/ai-models.routes.js';

// Initialize AI providers (triggers self-registration)
import '@libs/ai/index.js';
...
export async function buildApp() {
  ...
  // Set Zod validator (incoming request validation)
  ...
  // Response compression (gzip/deflate) for performance
  await app.register(compress, {
    global: false, // Opt-in per route; global causes empty body bugs with some Fastify versions
    threshold: 1024,
  ...
  await app.register(aiModelRoutes, { prefix: '/api/v1' });
